...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = 'mssql+pyodbc://Freddy_SQLLogin_1:52vgexnsdj@test_api.mssql.somee.com/test_api?driver=ODBC+Driver+18+for+SQL+Server&TrustServerCertificate=yes'
